...
Before project work, run Memory Preflight.

## 3. Start through the skill

Use `mvp-operating-system` for the first planning step.

The first output should be a mandatory Idea Intake. After that, produce a short Product/Technical Brief and, if needed, Decision Cards.
...
Create proposal/spec/tasks before implementation. Do not move to OpenSpec until Idea Intake exists.
