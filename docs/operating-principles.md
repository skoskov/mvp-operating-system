...
Implementation starts only after Idea Intake, Launch Market Research, Brand / Design System / UX Flow, Memory Preflight, required Decision Cards, Token/Time Budget, OpenSpec, independent review, and approved implementation slice.
